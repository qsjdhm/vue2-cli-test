<template>
    <div class="app-container">
        ...
        <div :key="'checkPermission' + key" style="margin-top: 60px">
            <aside>
                In some cases, using v-permission will have no effect. For example: Element-UI's Tab component or el-table-column and other
                scenes that dynamically render dom. You can only do this with v-if.
                <br />
                e.g.
            </aside>
...
<script>
import permission from '@/subtree/directives/permission/index.js'; // 权限判断指令
import checkPermission from '@/subtree/utils/permission'; // 权限判断函数
