...
<script>
import clip from '@/subtree/utils/clipboard'; // use clipboard directly
import clipboard from '@/subtree/directives/clipboard/index.js'; // use clipboard by v-directive
