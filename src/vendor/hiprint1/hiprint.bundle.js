            ...
            (hinnn.dateFormat = function (t, e) {
                if (t)
                    try {
                        ...
                        for (var i in (/(y+)/.test(e) && (e = e.replace(RegExp.$1, (o.getFullYear() + '').substr(4 - RegExp.$1.length))),
                        n)) {
                            new RegExp('(' + i + ')').test(e) &&
                ...
                (t.prototype.getPrintElementOptionEntity = function () {
                    ...
                    return (
                        Object.keys(this)
                            ...
                            .forEach(function (n) {
                                if (
                                    (('number' != typeof e[n] && 'string' != typeof e[n] && _typeof(e[n]) != _typeof(!0)) || (t[n] = e[n]),
                                    'style' == n)
                                ) {
                                    t.style = {};
                                    var i = e[n];
            ...
            BasePrintElement = (function () {
                ...
                return (
                        ...
                        if (o) {
                            ...
                            r &&
                                r.forEach(function (e) {
                                    var o = _print_element_option_PrintElementOptionItemManager__WEBPACK_IMPORTED_MODULE_2__.a.getItem(
                                        e.name
                                    );
                        ...
                        if (e) {
                            ...
                            n &&
                                n
                                    ...
                                    .forEach(function (e) {
                                        var n = _print_element_option_PrintElementOptionItemManager__WEBPACK_IMPORTED_MODULE_2__.a.getItem(
                                            e.name
                                        );
                    ...
                    (BasePrintElement.prototype.getFields = function () {
                        ...
                        return (
                            t || (t = _HiPrintlib__WEBPACK_IMPORTED_MODULE_6__.a.instance.getPrintTemplateById(this.templateId).getFields())
                        );
                    }),
                                ...
                                switch (r.keyCode) {
                                    case 37:
                                        (i = n.options.getLeft()),
                                            n.updateSizeAndPositionOptions(
                                                i - _HiPrintConfig__WEBPACK_IMPORTED_MODULE_1__.a.instance.movingDistance
                                            ),
                                    ...
                                    case 38:
                                        (o = n.options.getTop()),
                                            n.updateSizeAndPositionOptions(
                                                void 0,
                                                o - _HiPrintConfig__WEBPACK_IMPORTED_MODULE_1__.a.instance.movingDistance
                                            ),
            ...
            TableExcelHelper = (function () {
                ...
                return (
                    ...
                    (TableExcelHelper.getFooterFormatter = function (options, tablePrintElementType) {
                        ...
                        if (
                            (tablePrintElementType.footerFormatter && (footerFormatter = tablePrintElementType.footerFormatter),
                                    ...
                                    this.allColumns
                                        .map(function (t, e) {
                                            return (
                                                ...
                                                (t.checked
                                                    ? '<input type="checkbox"   checked column-id="' + (t.columnId || '') + '" />'
                                                    : '<input type="checkbox"  column-id="' + (t.columnId || '') + '" />') +
            ...
            TablePrintElement = (function (_super) {
                ...
                return (
                    ...
                    (TablePrintElement.prototype.getTableHtml = function (t, e) {
                        ...
                        if (!this.getField() && this.options.content)
                            return (
                                ...
                                (i = n.find('table')).addClass('hiprint-printElement-tableTarget'),
                                i
                            );
                                    ...
                                    ? (h.target && ((a = p), h.target.css('top', p + 'pt')),
                                      (f =
                                          l && null != this.options.lHeight
                                              ? p + (h.height > this.options.lHeight ? h.height : this.options.lHeight)
                                              : p + h.height))
                                    : (h.target && ((a = t.paperHeader), h.target.css('top', t.paperHeader + 'pt')),
                    ...
                    (TablePrintElement.prototype.getFooterFormatter = function () {
                        var footerFormatter = void 0;
                        if (
                            (this.printElementType.footerFormatter && (footerFormatter = this.printElementType.footerFormatter),
                    ...
                    if (0 != e.length) {
                        ...
                        e.forEach(function (i, o) {
                            i.forEach(function (i, r) {
                                0 == o
                                    ? 0 != r && ((n.colspan += i.cell.colspan), t.rows[i.rowIndex].removeCell(i.cell))
                ...
                (t.prototype.splitCell = function () {
                    ...
                    if (t) {
                        for (var i = t.rowIndex; i < t.rowIndex + t.cell.rowspan; i++) {
                            for (
                                var o = this.rows[i], r = i == t.rowIndex ? t.cell : s.getLeftTableCell(e[i], n), a = 0;
                                a < t.cell.colspan;
                                a++
                            ) {
                                (i == t.rowIndex && 0 == a) ||
                                    (r ? o.insertToTargetCellRight(r, o.createTableCell()) : o.insertCellToFirst(o.createTableCell()));
                            }
                        }
                    ...
                    o.hidroppables.each(function () {
                        ...
                        if (!e.hidroppable('options').disabled) {
                            ...
                            i.pageX > n.left && i.pageX < n.left + e.outerWidth() && i.pageY > n.top && i.pageY < n.top + e.outerHeight()
                                ? (this.entered || (t(this).trigger('_dragenter', [r]), (this.entered = !0)),
            ...
            parseOptions: function parseOptions(t, e) {
                ...
                if ((r && ('{' != r.substring(0, 1) && (r = '{' + r + '}'), (o = new Function('return ' + r)())), e)) {
                    for (var a = {}, p = 0; p < e.length; p++) {
                        var s = e[p];
                        if ('string' == typeof s)
                            a[s] = 'width' == s || 'height' == s || 'left' == s || 'top' == s ? parseInt(t.style[s]) || void 0 : i.attr(s);
                        else
                            for (var l in s) {
                                var u = s[l];
                                'boolean' == u
            ...
            (window.hiwebSocket = {
                ...
                reconnect: function reconnect() {
                    (this.state !== n && this.state !== i) ||
                        (this.stop(), this.ensureReconnectingState() && (console.log('Websocket reconnecting.'), this.start()));
                },
                stop: function stop() {
        ...
        var _r,
            ...
            v = (function (t) {
                function e(e, n) {
                    ...
                    return (
                        (i.options = new g.a(n)), i.options.setDefault(new g.a(p.a.instance.image.default).getPrintElementOptionEntity()), i
                    );
                }
                ...
                return (
                    ...
                    (e.prototype.getData = function (t) {
                        var e = '';
                        t
                            ? (e = this.getField() ? t[this.getField()] || '' : this.options.src || this.printElementType.getData())
            ...
            T = (function () {
                ...
                return (
                    ...
                    (t.prototype.createFooterLine = function () {
                        ...
                        (this.footerLinetarget = $(
                            ...
                            this.paperFooter == this.height &&
                                (this.footerLinetarget.css('top', this.mmheight - p.a.instance.paperHeightTrim + 'mm'),
                    ...
                    (t.prototype.updatePaperNumber = function (t, e, n) {
                        ...
                        this.paperNumberDisabled
                            ? i.hide()
                            : n && this.index % 2 == 1 && ((i[0].style.left = ''), i.css('right', this.paperNumberLeft + 'pt'));
                    }),
                    (t.prototype.formatPaperNumber = function (t, e) {
                        return (this.paperNumberFormat ? this.paperNumberFormat : this.defaultPaperNumberFormat)
            ...
            w = (function (t) {
                function e(e, n) {
                    var i = t.call(this, e) || this;
                    return (
                        (i.options = new b(n)), i.options.setDefault(new b(p.a.instance.longText.default).getPrintElementOptionEntity()), i
                    );
                }
            ...
            D = (function (t) {
                ...
                return (
                    ...
                    (e.prototype.getData = function (t) {
                        ...
                        if (
                            ((e = t ? t[this.getField()] || '' : this.options.testData || this.printElementType.getData() || ''),
                            this.options.format)
                        ) {
                    ...
                    (e.prototype.updateTargetText = function (t, e, n, i) {
                        ...
                        p = this.getField()
                            ...
                            : (n = r ? r(e, e, this.options, this._currenttemplateData, t) : e);
            ...
            F = (function (t) {
                function e(e, n) {
                    var i = t.call(this, e) || this;
                    return (
                        (i.options = new g.a(n)), i.options.setDefault(new g.a(p.a.instance.vline.default).getPrintElementOptionEntity()), i
                    );
                }
            ...
            A = (function (t) {
                function e(e, n) {
                    var i = t.call(this, e) || this;
                    return (
                        (i.options = new g.a(n)), i.options.setDefault(new g.a(p.a.instance.hline.default).getPrintElementOptionEntity()), i
                    );
                }
            ...
            k = (function (t) {
                function e(e, n) {
                    var i = t.call(this, e) || this;
                    return (
                        (i.options = new g.a(n)), i.options.setDefault(new g.a(p.a.instance.rect.default).getPrintElementOptionEntity()), i
                    );
                }
            ...
            V = (function (t) {
                function e(e, n) {
                    var i = t.call(this, e) || this;
                    return (
                        (i.options = new g.a(n)), i.options.setDefault(new g.a(p.a.instance.oval.default).getPrintElementOptionEntity()), i
                    );
                }
            ...
            J = (function (t) {
                function e(e, n) {
                    ...
                    return (
                        (i.options = new q(n)),
                        i.options.setDefault(new q(p.a.instance.tableCustom.default).getPrintElementOptionEntity()),
                ...
                return (
                    ...
                    (e.prototype.getTableHtml = function (t, e) {
                        ...
                        return (
                            n.append(X.a.createTableHead(this.columns, this.options.getWidth())),
                            n.append(X.a.createTableRow(this.columns, t, this.options, this.printElementType)),
                        ...
                        for (var u = e.outerHeight(), d = []; ; ) {
                            if (u <= l) {
                                if (0 == s.find('tr').length) {
                                    a && this.options.autoCompletion && (this.autoCompletion(l, e), (u = e.outerHeight())),
                                        (p = {
                                            target: e.clone(),
                    ...
                    (e.prototype.onResize = function (e, n, i, o, r) {
                        t.prototype.updateSizeAndPositionOptions.call(this, r, o, i, n),
                            X.a.resizeTableCellWidth(this.designTarget, this.columns, this.options.getWidth());
                    }),
                    (e.prototype.getReizeableShowPoints = function () {
                        return ['s', 'e'];
                    }),
            ...
            nt = (function () {
                ...
                return (
                    (t.createPrintElementType = function (t) {
                        return (
                            (t.type = t.type || 'text'),
                            'text' == t.type ? new et(t) : 'table' == t.type ? new h(t) : 'tableCustom' == t.type ? new Z(t) : new j(t)
                        );
                    }),
                    t
                );
            ...
            pt = (function () {
                ...
                return (
                    ...
                    (t.prototype.getHtml = function (t, e, n, i, o) {
                        ...
                        if (
                            (i
                                ...
                                : ((a = s.createTarget()), (l = s.createNewPage(p.length)), p.push(l), a.append(l.getTarget())),
                            this.printElements
                                .filter(function (t) {
                                ...
                                .forEach(function (e) {
                                    ...
                                    i.referenceElement.isPositionLeftOrRight(e.options.getTop())
                                        ? ((l = p[i.referenceElement.beginPrintPaperIndex]), (n = e.getHtml(l, t)))
                                        : ((l = p[i.referenceElement.endPrintPaperIndex]), (n = e.getHtml(l, t))),
                                        n.forEach(function (t, i) {
                                            t.referenceElement &&
                                                ...
                                                i > 0 &&
                                                    (l.index < p.length - 1
                                                        ? (l = p[l.index + 1])
                                                        : ((l = s.createNewPage(p.length, l.referenceElement)), p.push(l)),
                        ...
                        t.getTarget().hidroppable({
                            ...
                            onDrop: function onDrop(n, i) {
                                ...
                                a.updateSizeAndPositionOptions(
                                    e.mathroundToporleft(r.left - o.a.px.toPt(e.target.offset().left)),
                                    e.mathroundToporleft(r.top - o.a.px.toPt(e.target.offset().top))
                                ),
                    ...
                    (t.prototype.getPrintElementTypeByEntity = function (t) {
                        var e;
                        return (
                            (e = t.tid ? a.instance.getElementType(t.tid) : nt.createPrintElementType(t.printElementType)) ||
                    ...
                    (t.prototype.getPrintSizeStyle = function () {
                        return this.paperType
                            ...
                            : 'size:' +
                                  ...
                                  this.height +
                                  'mm ' +
                                  (this.orient ? (1 == this.orient ? 'portrait' : 'landscape') : '') +
                                  ';';
                    }),
                        ...
                        this.designPaper
                            ...
                            .on('mousemove', function (e) {
                                s.a.instance.draging ||
                                    (1 === e.buttons && (t.mouseRect.updateRect(e.pageX, e.pageY), t.updateRectPanel(t.mouseRect)));
                            })
                    ...
                    (t.prototype.updateRectPanel = function (t) {
                        ...
                        this.mouseRect.target ||
                            ...
                            this.mouseRect.target.hidraggable({
                                onDrag: function onDrag(t, n, i) {
                                    (e.mouseRect.lastLeft = e.mouseRect.lastLeft ? e.mouseRect.lastLeft : n),
                                        (e.mouseRect.lastTop = e.mouseRect.lastTop ? e.mouseRect.lastTop : i),
                                ...
                                onBeforeDrag: function onBeforeDrag(t) {
                                    e.mouseRect.target.focus(),
                                        ...
                                        e.mouseRect.mouseRectSelectedElement ||
                                            (e.mouseRect.mouseRectSelectedElement = e.getElementInRect(e.mouseRect));
                                },
                                onStopDrag: function onStopDrag(t) {
                                    s.a.instance.draging = !1;
                                }
            ...
            ct = (function () {
                function t(t) {
                    ...
                    n.template &&
                        ...
                        n.paginationContainer &&
                            ((this.printPaginationCreator = new dt(n.paginationContainer, this)),
                ...
                return (
                    ...
                    (t.prototype.createContainer = function (t) {
                        t
                            ? ((this.container = $(t)), this.container.addClass('hiprint-printTemplate'))
                                ...
                                l.open('GET', $(p).attr('href')),
                                    (l.onreadystatechange = function () {
                                        if (
                                            4 === l.readyState &&
                                            200 === l.status &&
                                            ((o[a + ''] = '<style rel="stylesheet" type="text/css">' + l.responseText + '</style>'),
                                            ++i == r.length)
                                        ) {
                    ...
                    (t.prototype.initAutoSave = function () {
                        var t = this;
                        this.autoSave &&
                            o.a.event.on('hiprintTemplateDataChanged_' + this.id, function () {
                                hiLocalStorage.saveLocalData(
                                    t.autoSaveKey || 'hiprintAutoSave',
                                    JSON.stringify(1 == t.autoSaveMode ? t.getJson() : t.getJsonTid())
                                );
                            });
                    }),
                    t
                ...
                t &&
                    t.templates.forEach(function (n, i) {
                        ...
                        t.imgToBase64 && (o.imgToBase64 = !0),
                            e ? e.append(n.template.getHtml(n.data, o).html()) : (e = n.template.getHtml(n.data, o));
                    }),
                e
            );
        }
