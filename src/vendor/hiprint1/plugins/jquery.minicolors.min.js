...
!(function (i) {
    ...
    function t(t, o) {
        ...
        if (!t.data('minicolors-initialized')) {
            if (
                ...
                for (
                    l.addClass('minicolors-with-swatches'), n = i('<ul class="minicolors-swatches"></ul>').appendTo(l), h = 0;
                    h < o.swatches.length;
                    ++h
                )
    ...
    function n(i, t, o) {
        ...
        t.originalEvent.changedTouches &&
            ((g = t.originalEvent.changedTouches[0].pageX - p), (m = t.originalEvent.changedTouches[0].pageY - u)),
            g < 0 && (g = 0),
            m < 0 && (m = 0),
            g > i.width() && (g = i.width()),
    ...
    function e(i, t) {
        function o(i, t) {
            ...
            return i.length && t
                ? ((o = i.offset().left),
                  (s = i.offset().top),
                  { x: o - t.offset().left + i.outerWidth() / 2, y: s - t.offset().top + i.outerHeight() / 2 })
                : null;
        }
        var s,
            a,
    ...
    function d(t, o) {
        ...
        return s
            ? (void 0 === a && (a = 1),
              o ? 'rgba(' + s.r + ', ' + s.g + ', ' + s.b + ', ' + parseFloat(a) + ')' : 'rgb(' + s.r + ', ' + s.g + ', ' + s.b + ')')
            : null;
    }
    function p(i, t) {
                        ...
                        : (v(e.val()) ? (s = g(e.val(), !0)) : ((o = u(e.val(), !0)), (s = o ? I(o) : null)),
                          (n =
                              null === s
                                  ...
                                  ? g(
                                        r.opacity
                                            ? 'rgba(' + s.r + ',' + s.g + ',' + s.b + ',' + e.attr('data-opacity') + ')'
                                            : 'rgb(' + s.r + ',' + s.g + ',' + s.b + ')'
                                    )
                                  : C(s))),
