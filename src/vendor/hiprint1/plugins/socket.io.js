    ...
    return (function (t) {
            ...
            function r(t, e) {
                ...
                (e = e || ('undefined' != typeof location && location)),
                    ...
                    'string' == typeof t &&
                        ...
                        /^(https?|wss?):\/\//.test(t) ||
                            (i('protocol-less url %s', t), (t = 'undefined' != typeof e ? e.protocol + '//' + t : 'https://' + t)),
                        i('parse %s', t),
                        (n = o(t))),
        ...
        function (t, e, n) {
            (function (r) {
                ...
                function i(t) {
                    ...
                    if (
                        ((t[0] =
                            (n ? '%c' : '') + this.namespace + (n ? ' %c' : ' ') + t[0] + (n ? '%c ' : ' ') + '+' + e.humanize(this.diff)),
                        n)
                    ) {
        ...
        function (t, e) {
            ...
            function p(t) {
                ...
                if (
                    240 == (248 & e) &&
                    ((n = c()), (r = c()), (i = c()), (s = ((7 & e) << 18) | (n << 12) | (r << 6) | i), s >= 65536 && s <= 1114111)
                )
                    return s;
        ...
        function (t, e) {
            ...
            for (
                var i, s = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_'.split(''), a = 64, c = {}, p = 0, u = 0;
                u < a;
                u++
            )
                c[s[u]] = u;
