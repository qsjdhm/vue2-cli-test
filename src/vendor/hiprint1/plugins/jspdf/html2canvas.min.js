...
!(function (A, e) {
    ...
    ***************************************************************************** */ var r = function (
    ...
    function w(A, e, t, r, B) {
        ...
        if (8 === g(n, e)) return '÷';
        if (11 === q.get(A[n]) && (c === X || c === P || c === x)) return Y;
        if (7 === i || 7 === c) return Y;
        if (9 === i) return Y;
        if (-1 === [H, d, f].indexOf(i) && 9 === c) return Y;
        if (-1 !== [I, T, m, v, y].indexOf(c)) return Y;
        if (g(n, e) === O) return Y;
        if (C(23, O, n, e)) return Y;
        if (C([I, T], L, n, e)) return Y;
        if (C(12, 12, n, e)) return Y;
        if (i === H) return '÷';
        ...
        if ((i === S && -1 !== [X, P, x].indexOf(c)) || (-1 !== [X, P, x].indexOf(i) && c === b)) return Y;
        if ((-1 !== Z.indexOf(i) && -1 !== AA.indexOf(c)) || (-1 !== AA.indexOf(i) && -1 !== Z.indexOf(c))) return Y;
        if (
            (-1 !== [S, b].indexOf(i) && (c === D || (-1 !== [O, f].indexOf(c) && e[1 + o] === D))) ||
            (-1 !== [O, f].indexOf(i) && c === D) ||
            (i === D && -1 !== [D, y, v].indexOf(c))
        )
            return Y;
        if (-1 !== [D, y, v, I, T].indexOf(c))
            for (var Q = n; 0 <= Q; ) {
                if ((w = e[Q]) === D) return Y;
        ...
        if (
            ...
            return Y;
        if ((-1 !== tA.indexOf(i) && -1 !== [R, b].indexOf(c)) || (-1 !== tA.indexOf(c) && i === S)) return Y;
        if (-1 !== Z.indexOf(i) && -1 !== Z.indexOf(c)) return Y;
        if (i === v && -1 !== Z.indexOf(c)) return Y;
        if ((-1 !== Z.concat(D).indexOf(i) && c === O) || (-1 !== Z.concat(D).indexOf(c) && i === T)) return Y;
        if (41 === i && 41 === c) {
            for (var u = t[n], U = 1; 0 < u && 41 === e[--u]; ) U++;
            if (U % 2 != 0) return Y;
        }
        return i === P && c === x ? Y : '÷';
    }
        ...
        var e = (function (A, B) {
                ...
                return (
                    A.forEach(function (A, e) {
                        ...
                        if (0 === e) return s.push(e), n.push(_);
                        var r = n[e - 1];
    ...
    var CA = { type: sA.LEFT_PARENTHESIS_TOKEN },
        ...
        MA = { type: sA.EOF_TOKEN },
        SA =
            ((yA.prototype.write = function (A) {
                var e;
                (e = this._value).push.apply(e, c(A));
            }),
            ...
            (yA.prototype.consumeToken = function () {
                ...
                switch (A) {
                    ...
                    case 64:
                        ...
                        if (UA(c, Q, w)) return (n = this.consumeName()), { type: sA.AT_KEYWORD_TOKEN, value: n };
                        break;
                    case 91:
                        return vA;
                    case 92:
            ...
            (yA.prototype.consumeUrlToken = function () {
                ...
                for (;;) {
                    ...
                    if (-1 === B || 41 === B) return { type: sA.URL_TOKEN, value: l.apply(void 0, A) };
                    if (cA(B))
                        return (
                    ...
                    if (92 === B) {
                        if (!uA(B, this.peekCodePoint(0))) return this.consumeBadUrlRemnants(), IA;
            ...
            (yA.prototype.consumeStringToken = function (A) {
                for (var e = ''; ; ) {
                    ...
                    if (-1 === t || t === A) return { type: sA.STRING_TOKEN, value: e };
                    if (10 === t) return this.reconsumeCodePoint(t), TA;
                    if (92 === t) {
                        var r = this.peekCodePoint(0);
                        -1 !== r && (10 === r ? this.consumeCodePoint() : uA(t, r) && (e += l(this.consumeEscapedCodePoint())));
                    } else e += l(t);
                }
            }),
    ...
    var _A =
        ...
        (PA.prototype.consumeSimpleBlock = function (A) {
            for (var e = { type: A, values: [] }, t = this.consumeToken(); ; ) {
                if (t.type === sA.EOF_TOKEN || ne(t, A)) return e;
    ...
    var Ce,
        ...
        Ee,
        Fe,
        he = { hsl: le, hsla: le, rgb: Be, rgba: Be },
        He = {
    ...
    function fe(A, t) {
        ...
        for (s = 0; s < B.length; s++) {
            ...
            if (null === c) null === a && (a = s);
                ...
                for (var Q = s - a, w = (c - B[a - 1]) / (1 + Q), u = 1; u <= Q; u++) B[a + u - 1] = w * u;
                a = null;
            }
        }
        ...
        return [
            ...
            function (A, e) {
                var t = e[0],
                    r = e[1],
                    B = Ne(n - t, s - r);
                return (o ? B < A.optimumDistance : B > A.optimumDistance) ? { optimumCorner: e, optimumDistance: B } : A;
            },
    ...
    function Ie(A) {
        ...
        return (
            WA(A).forEach(function (A, e) {
                if (0 === e) {
                    var t = A[0];
                    if (t.type === sA.IDENT_TOKEN && -1 !== ['top', 'left', 'right', 'bottom'].indexOf(t.value)) return void (B = Ae(A));
                    if ($A(t)) return void (B = (ce(t) + Qe(270)) % Qe(360));
                }
                var r = de(A);
                n.push(r);
            }),
                              ...
                              return (
                                  ...
                                  Oe(t)
                                      .then(function (A) {
                                          ...
                                          (n.fillStyle = 'red'), n.fillRect(0, 0, B, B);
                                      ...
                                      .then(function (A) {
                                          return n.drawImage(A, 0, 0), Te(n.getImageData(0, 0, B, B).data);
                                      })
                                      .catch(function () {
                                          return !1;
                                      })
    ...
    var Me =
        ((Se.create = function (A, e) {
            return (Se._caches[A] = new ye(A, e));
        }),
        ...
        (Se.getOrigin = function (A) {
            var e = Se._link;
            return e ? ((e.href = A), (e.href = e.href), e.protocol + e.hostname + e.port) : 'about:blank';
        }),
        (Se.isSameOrigin = function (A) {
            return Se.getOrigin(A) === Se._origin;
        }),
        (Se.setContext = function (A) {
            (Se._link = A.document.createElement('a')), (Se._origin = Se.getOrigin(A.location.href));
        }),
        ...
        (Se.attachInstance = function (A) {
            Se._current = A;
        }),
        (Se.detachInstance = function () {
            Se._current = null;
        }),
        (Se._caches = {}),
        (Se._origin = 'about:blank'),
        (Se._current = null),
        Se);
    function Se() {}
    var ye =
                    ...
                    switch (A.label) {
                        case 0:
                            return (
                                ...
                                e || !1 !== this._options.allowTaint || ke(s) || t || r ? ((B = s), t ? [4, this.proxy(B)] : [3, 2]) : [2]
                            );
                        case 1:
                            (B = A.sent()), (A.label = 2);
                        case 2:
            ...
            return new Promise(function (e, t) {
                ...
                if (
                    ((B.onload = function () {
                        ...
                        else t('Failed to proxy resource ' + i + ' with status code ' + B.status);
                    }),
                    (B.onerror = t),
                          ...
                          (t = A.reduce(function (A, e) {
                              if (zA(e))
                                  switch (e.value) {
                                      ...
                                      case tt:
                                      case Ze:
                                          return (n = nt.CLOSEST_SIDE), !1;
                                      case je:
                                          return (n = nt.FARTHEST_SIDE), !1;
                                      case $e:
                                          return (n = nt.CLOSEST_CORNER), !1;
                                      case 'cover':
                                      case At:
                                          return (n = nt.FARTHEST_CORNER), !1;
                                  }
                              else if (YA(e) || qA(e)) return Array.isArray(n) || (n = []), n.push(e), !1;
                              return A;
                          }, t)),
                    t)
                ) {
            ...
            'linear-gradient': function (A) {
                ...
                return (
                    WA(A).forEach(function (A, e) {
                        if (0 === e) {
                            var t = A[0];
                            if (t.type === sA.IDENT_TOKEN && 'to' === t.value) return void (B = Ae(A));
                            if ($A(t)) return void (B = ce(t));
                        }
                        var r = de(A);
                        n.push(r);
                    }),
                                ...
                                if (r)
                                    ...
                                    switch (e.value) {
                                        ...
                                        case 'at':
                                            return !(r = !0);
                                        case Ze:
                                            return (s = nt.CLOSEST_SIDE), !1;
                                        case 'cover':
                                        case je:
                                            return (s = nt.FARTHEST_SIDE), !1;
                                        case tt:
                                        case $e:
                                            return (s = nt.CLOSEST_CORNER), !1;
                                        case At:
                                            return (s = nt.FARTHEST_CORNER), !1;
                                    }
                        ...
                        if (t.type === sA.FUNCTION)
                            if ('from' === t.name) {
                                ...
                                if (2 === B.length) {
                                    ...
                                    var n = B[0];
                                    VA(n) &&
                                        s.push({ stop: { type: sA.PERCENTAGE_TOKEN, number: 100 * n.number, flags: n.flags }, color: r });
                                }
                            }
                    }),
                    o === xe.LINEAR_GRADIENT
    ...
    ((it = ot || (ot = {}))[(it.REPEAT = 0)] = 'REPEAT'), (it[(it.NO_REPEAT = 1)] = 'NO_REPEAT'), (it[(it.REPEAT_X = 2)] = 'REPEAT_X');
    var Ut,
        lt,
        Ct = {
    ...
    var Lr,
        ...
        Mr = { type: sA.PERCENTAGE_TOKEN, number: 50, flags: 4 },
        Sr = [Mr, Mr],
        yr = {
    ...
    var tB = {
        ...
        iB =
            ...
            (aB.prototype.isInlineLevel = function () {
                return (
                    AB(this.display, 4) ||
                    AB(this.display, 33554432) ||
                    AB(this.display, 268435456) ||
                    AB(this.display, 536870912) ||
                    AB(this.display, 67108864) ||
                    AB(this.display, 134217728)
                );
            }),
            aB);
    function aB(A) {
        (this.backgroundClip = uB(me, A.backgroundClip)),
            ...
            (this.borderTopStyle = uB(Mt, A.borderTopStyle)),
            (this.borderRightStyle = uB(St, A.borderRightStyle)),
    ...
    var cB,
        QB = function (A) {
            (this.content = uB(rB, A.content)), (this.quotes = uB(sB, A.quotes));
        },
        wB = function (A) {
            (this.counterIncrement = uB(BB, A.counterIncrement)), (this.counterReset = uB(nB, A.counterReset));
        },
        uB = function (A, e) {
            var t = new SA(),
        ...
        gB = function (A, e, t) {
            ...
            var B = r.createRange();
            return B.setStart(A, e), B.setEnd(A, e + t), N.fromClientRect(B.getBoundingClientRect());
        },
        EB = function (A, e) {
                    ...
                    return (
                        e.forEach(function (A) {
                            if (t.textDecorationLine.length || 0 < A.trim().length)
                                if (ve.SUPPORT_RANGE_BOUNDS) B.push(new lB(A, gB(r, n, A.length)));
                                else {
    ...
    var bB,
        MB = (A(SB, (bB = UB)), SB);
    function SB(A) {
        var e = bB.call(this, A) || this;
        return (e.start = A.start), (e.reversed = 'boolean' == typeof A.reversed && !0 === A.reversed), e;
    }
    var yB,
        _B = [{ type: sA.DIMENSION_TOKEN, flags: 0, unit: 'px', number: 3 }],
        PB = [{ type: sA.PERCENTAGE_TOKEN, flags: 0, number: 50 }],
        xB = 'checkbox',
        VB = 'radio',
        zB = 'password',
        XB = 707406591,
            ...
            (e.type !== xB && e.type !== VB) ||
                ...
                (e.bounds = (function (A) {
                    return A.width > A.height
                        ? new N(A.left + (A.width - A.height) / 2, A.top, A.height, A.height)
                        : A.width < A.height
                        ? new N(A.left, A.top + (A.height - A.width) / 2, A.width, A.width)
                        : A;
                })(e.bounds))),
            e.type)
        ) {
        ...
        try {
            if (A.contentWindow && A.contentWindow.document && A.contentWindow.document.documentElement) {
                ...
                var t = A.contentWindow.document.documentElement
                        ? $B(getComputedStyle(A.contentWindow.document.documentElement).backgroundColor)
                        : He.TRANSPARENT,
                    r = A.contentWindow.document.body
                        ? $B(getComputedStyle(A.contentWindow.document.body).backgroundColor)
                        : He.TRANSPARENT;
    ...
    var Bn = ['OL', 'UL', 'MENU'],
        nn = function (A, e, t) {
            for (var r = A.firstChild, B = void 0; r; r = B)
                if (((B = r.nextSibling), Qn(r) && 0 < r.data.trim().length)) e.textNodes.push(new hB(r, e.styles));
                else if (wn(r)) {
                    var n = sn(r);
                    n.styles.isVisible() &&
                        (an(r, n, t) ? (n.flags |= 4) : cn(n.styles) && (n.flags |= 2),
        ...
        an = function (A, e, t) {
            return (
                e.styles.isPositionedWithZIndex() || e.styles.opacity < 1 || e.styles.isTransformed() || (En(A) && t.styles.isTransparent())
            );
        },
        cn = function (A) {
    ...
    function mn(A, e, t) {
        ...
        var r = e.length;
        return (
            In(Math.abs(A), r, !1, function (A) {
                return e[Math.floor(A % r)];
            }) + t
        );
    }
    function Rn(A, e, t, r, B, n) {
        if (A < -9999 || 9999 < A) return yn(A, tr.CJK_DECIMAL, 0 < B.length);
        var s = Math.abs(A),
            o = B;
        if (0 === s) return e[0] + o;
    ...
    var Ln,
        ...
        yn = function (A, e, t) {
            ...
            switch (e) {
                ...
                case tr.KOREAN_HANGUL_FORMAL:
                    return Rn(A, '영일이삼사오육칠팔구', '십백천만', Sn, n, 7);
                case tr.KOREAN_HANJA_INFORMAL:
                    return Rn(A, '零一二三四五六七八九', '十百千萬', Sn, n, 0);
                case tr.KOREAN_HANJA_FORMAL:
                    return Rn(A, '零壹貳參四五六七八九', '拾百千', Sn, n, 7);
                case tr.DEVANAGARI:
                    return Tn(A, 2406, 2415, !0, r);
                case tr.GEORGIAN:
                    return Kn(A, 1, 19999, Mn, tr.DECIMAL, r);
                case tr.GUJARATI:
                    return Tn(A, 2790, 2799, !0, r);
                case tr.GURMUKHI:
                    return Tn(A, 2662, 2671, !0, r);
                case tr.HEBREW:
                    return Kn(A, 1, 10999, bn, tr.DECIMAL, r);
                case tr.HIRAGANA:
        ...
        _n = 'data-html2canvas-ignore',
        Pn =
            ((xn.prototype.toIFrame = function (A, e) {
                var t = this,
                    r = Xn(A, e);
            ...
            (xn.prototype.cloneNode = function (A) {
                if (Qn(A)) return document.createTextNode(A.data);
                ...
                if (un(A) && e) {
                    ...
                    for (
                        var s = this.counters.parse(new wB(r)), o = this.resolvePseudoContent(A, t, B, Ln.BEFORE), i = A.firstChild;
                        i;
                        i = i.nextSibling
                    )
                        (wn(i) &&
                            ...
                            (this.options.copyStyles && wn(i) && rn(i)) ||
    ...
    var Vn,
        ...
        qn = '___html2canvas___pseudoelement_before',
    ...
    var is,
        ...
        cs = function (A) {
            var e = A.styles,
                ...
                U = w[1],
                l = [];
            l.push((B + o) / t.width), l.push((u + c) / t.width), l.push((n + U) / t.height), l.push((i + Q) / t.height);
            var C = Math.max.apply(Math, l);
            1 < C && ((B /= C), (n /= C), (o /= C), (i /= C), (c /= C), (Q /= C), (u /= C), (U /= C));
            var g = t.width - o,
                E = t.height - Q,
                F = t.width - c,
                h = t.height - U,
            ...
            (this.topLeftBorderBox = 0 < B || 0 < n ? us(t.left, t.top, B, n, is.TOP_LEFT) : new ts(t.left, t.top)),
                ...
                (this.topLeftPaddingBox =
                    0 < B || 0 < n
                        ? us(t.left + p, t.top + H, Math.max(0, B - p), Math.max(0, n - H), is.TOP_LEFT)
                ...
                (this.bottomLeftPaddingBox =
                    0 < u || 0 < U
                        ? us(t.left + p, t.top + h, Math.max(0, u - p), U - f, is.BOTTOM_LEFT)
                        : new ts(t.left + p, t.top + t.height - f)),
                (this.topLeftContentBox =
                    0 < B || 0 < n
                        ? us(t.left + p + T, t.top + H + N, Math.max(0, B - (p + T)), Math.max(0, n - (H + N)), is.TOP_LEFT)
    ...
    var ps = function (c, Q, w, u) {
                    ...
                    if (A.styles.isPositioned() || A.styles.opacity < 1 || A.styles.isTransformed()) {
                        ...
                        if (o < 0) {
                            ...
                            n.negativeZIndex.some(function (A, e) {
                                return o > A.element.container.styles.zIndex.order && ((i = e), !0);
                            }),
                                n.negativeZIndex.splice(i, 0, s);
                        } else if (0 < o) {
                            var a = 0;
                            n.positiveZIndex.some(function (A, e) {
                                return o > A.element.container.styles.zIndex.order && ((a = e + 1), !0);
                            }),
                                n.positiveZIndex.splice(a, 0, s);
                        } else n.zeroOrAutoZIndexOrTransformedOrOpacity.push(s);
                    } else A.styles.isFloating() ? n.nonPositionedFloats.push(s) : n.nonPositionedInlineLevel.push(s);
                    ps(r, s, e ? s : w, B);
                } else A.styles.isInlineLevel() ? Q.inlineLevel.push(r) : Q.nonInlineLevel.push(r), ps(r, Q, w, B);
                AB(A.flags, 8) && Ns(A, B);
            });
        },
        Ns = function (A, e) {
            for (var t = A instanceof MB ? A.start : 1, r = A instanceof MB && A.reversed, B = 0; B < e.length; B++) {
                var n = e[B];
        ...
        Ks = function (A, e, t, r) {
            var B = [];
            return (
                os(A) ? B.push(A.subdivide(0.5, !1)) : B.push(A),
                os(t) ? B.push(t.subdivide(0.5, !0)) : B.push(t),
                os(r) ? B.push(r.subdivide(0.5, !0).reverse()) : B.push(r),
                os(e) ? B.push(e.subdivide(0.5, !1).reverse()) : B.push(e),
                B
            );
        },
        Is = function (A, e, t) {
            ...
            if (zA(s) && (s.value === Ut.CONTAIN || s.value === Ut.COVER))
                return fs(n)
                    ? t.width / t.height < n != (s.value === Ut.COVER)
                        ? [t.width, t.width / n]
                        : [t.height * n, t.height]
                    : [t.width, t.height];
            var a = fs(r),
        ...
        ms = function (A, e, t, r, B) {
            ...
            switch (A) {
                ...
                case ot.REPEAT_Y:
                    return [
                        new ts(Math.round(r.left + n), Math.round(r.top)),
                        new ts(Math.round(r.left + n + o), Math.round(r.top)),
                        new ts(Math.round(r.left + n + o), Math.round(r.height + r.top)),
                        new ts(Math.round(r.left + n), Math.round(r.height + r.top))
                    ];
                case ot.NO_REPEAT:
                    return [
                        new ts(Math.round(r.left + n), Math.round(r.top + s)),
                        new ts(Math.round(r.left + n + o), Math.round(r.top + s)),
                        new ts(Math.round(r.left + n + o), Math.round(r.top + s + i)),
                        new ts(Math.round(r.left + n), Math.round(r.top + s + i))
                    ];
                default:
                    return [
                        new ts(Math.round(B.left), Math.round(B.top)),
                        new ts(Math.round(B.left + B.width), Math.round(B.top)),
                        new ts(Math.round(B.left + B.width), Math.round(B.height + B.top)),
                        new ts(Math.round(B.left), Math.round(B.height + B.top))
                    ];
            }
        },
        Rs = 'Hidden Text',
                    ...
                    switch (A.label) {
                        case 0:
                            return (e = t.element.container.styles).isVisible()
                                ? ((this.ctx.globalAlpha = e.opacity), [4, this.renderStackContent(t)])
                                : [3, 2];
                        case 1:
                            A.sent(), (A.label = 2);
                        case 2:
            ...
            return B(this, void 0, void 0, function () {
                ...
                return M(this, function (A) {
                    switch (A.label) {
                        ...
                        case 8:
                            if ((e instanceof IB && this.renderReplacedElement(e, t, e.canvas), !(e instanceof RB))) return [3, 12];
                            A.label = 9;
                        case 9:
                        ...
                        case 14:
                            ...
                            if (!AB(e.styles.display, 2048)) return [3, 20];
                                    ...
                                    return M(this, function (A) {
                                        switch (A.label) {
                                            ...
                                            case 4:
                                                return (
                                                    t &&
                                                        ((B = Hs(b, v, [t.width, t.height, t.width / t.height])),
                                                        (g = B[0]),
                                                        (f = B[1]),
                                                        (p = B[2]),
                                                        (h = B[3]),
                    ...
                    switch (A.label) {
                        case 0:
                            return (
                                ...
                                (B = Ms(Ts(e.backgroundClip, 0), c.curves)),
                        ...
                        case 3:
                            return s < o.length
                                ? (i = o[s]).style === ht.NONE || ee(i.color)
                                    ? [3, 5]
                                    : [4, this.renderBorder(i.color, n++, c.curves)]
                                : [3, 6];
                        case 4:
                            A.sent(), (A.label = 5);
                        case 5:
    ...
    Me.setContext(window);
    var Vs = function (d, f) {
            return B(void 0, void 0, void 0, function () {
                var e, t, r, B, n, s, o, i, a, c, Q, w, u, U, l, C, g, E, F, h, H;
                return M(this, function (A) {
                    switch (A.label) {
                        case 0:
                            if (!(e = d.ownerDocument)) throw new Error('Element is not attached to a Document');
                            ...
                            return (
                                ...
                                (B = p({}, r, f)),
                                (n = new N(B.scrollX, B.scrollY, B.windowWidth, B.windowHeight)),
                                (s = e.documentElement ? Ps(getComputedStyle(e.documentElement).backgroundColor) : He.TRANSPARENT),
                                (o = e.body ? Ps(getComputedStyle(e.body).backgroundColor) : He.TRANSPARENT),
                                (i =
                                    d === e.documentElement
                                        ? ee(s)
                                            ? ee(o)
                                                ? B.backgroundColor
                                                    ? Ps(B.backgroundColor)
                                                    : null
                                                : o
                                            : s
                                        : B.backgroundColor
                                        ? Ps(B.backgroundColor)
                                        : null),
                                (a = (Math.round(1e3 * Math.random()) + Date.now()).toString(16)),
                                De.create(a),
                                (c = Me.create(a, B)),
                                De.getInstance(a).debug('Starting document clone'),
                                (Q = new Pn(d, {
                                    id: a,
                                    onclone: B.onclone,
                        ...
                        case 1:
                            return (
                                ...
                                (F = {
                                    ...
                                    backgroundColor: i,
                                    scale: B.scale,
                                    x: 'number' == typeof B.x ? B.x : g,
                                    y: 'number' == typeof B.y ? B.y : E,
                                    scrollX: B.scrollX,
                                    scrollY: B.scrollY,
                                    width: 'number' == typeof B.width ? B.width : Math.ceil(l),
                                    height: 'number' == typeof B.height ? B.height : Math.ceil(C),
                                    windowWidth: B.windowWidth,
                                    windowHeight: B.windowHeight
                                }),
                                B.foreignObjectRendering
                                    ? (De.getInstance(a).debug('Document cloned, using foreign object rendering'), [4, new ys(F).render(w)])
                                    : [3, 3]
                            );
                        case 2:
                            return (h = A.sent()), [3, 5];
                        case 3:
                            return (
                                De.getInstance(a).debug('Document cloned, using computed rendering'),
                                Me.attachInstance(c),
                                De.getInstance(a).debug('Starting DOM parsing'),
                                (H = on(w)),
                                Me.detachInstance(),
                                i === H.styles.backgroundColor && (H.styles.backgroundColor = He.TRANSPARENT),
                                De.getInstance(a).debug('Starting renderer'),
                                [4, new vs(F).render(H)]
                            );
                        case 4:
                            (h = A.sent()), (A.label = 5);
                        case 5:
                            return (
                                !0 === B.removeContainer &&
                                    (zs(u) || De.getInstance(a).error('Cannot detach cloned iframe as it is not in the DOM anymore')),
                                De.getInstance(a).debug('Finished rendering'),
                                De.destroy(a),
                                Me.destroy(a),
                                [2, h]
                            );
